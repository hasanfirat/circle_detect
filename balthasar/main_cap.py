...
def main(kaynak):
    ...
    ap.add_argument("--source", "-s", default=kaynak,
...
def putIterationsPerSec(frame, iterations_per_sec):
    ...
    frame,inrange,motor_hareket = detector_code.kamera_islem(frame)
    fps, prev_frame_time, new_frame_time = detector_code.fps_func(prev_frame_time,new_frame_time)
    cv2.putText(frame, fps + " FPS", (10,23), cv2.FONT_HERSHEY_SIMPLEX,0.4, (0,0,255), 1, cv2.LINE_AA)    
    return frame
